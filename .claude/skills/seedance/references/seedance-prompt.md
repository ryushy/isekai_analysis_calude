...
- Seedanceプロンプト: media/storyboard/<case>/04_seedance_prompt.md の「## Video Prompt」コードブロックをそのまま使用
...
- 保存: media/storyboard/<case>/outputs/seedance/<project>_<scene>_vertical_final_vN.mp4
