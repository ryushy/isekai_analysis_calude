...
- `media/` … トランスメディア（`storyboard/<案件>/`・`参考画像/`）。手順は [media/README.md](media/README.md)
...
4. 主人公の容姿正典＝[docs/settings/protagonist_core.md §0.1](docs/settings/protagonist_core.md)＋`media/参考画像/`。
