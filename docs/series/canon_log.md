...
| C-027 | **深層での姿＝積み上げた力（履歴の密度・literacy・編集層）の外在化＝レベルでコスチューム化**。表層＝普段着／深層＝能力を映す装束。弱者ほど素・達人ほど精緻（成長が見た目で分かる）。**AW差別化＝身体ごと潜った本人の姿が書き換わるだけ（着替えでない・傷も身体に反映）**。澪＝深層は緋色の和風射手装束（黒髪・image.png 黒髪版）／ナギ＝現状ほぼ素＋白ヘッドホン（強くなるほど雨motifが顕れる） | [../settings/digital_tattoo.md §6.5](../settings/digital_tattoo.md) |
...
| C-024 | 舞台＝横浜（自宅＝**本牧**・駅無し／学校＝**山手**／第1ダンジョン＝**コスモワールドの非常口**＝みなとみらいの大観覧車。閉園した遊園地に回り続ける観覧車・蔦に呑まれた遊具・火の粉の灯＝終わらない「炎と森のカーニバル」／固有現象＝記録の雨／**native（カタログ登録）＝ずぶ濡れの獣**だが、Ep1の遭遇は**深層の異常（バグ）の介入で「道化の楽団＝謎集団」が上書き侵入**（C-027）。SEKAI NO OWARI〈炎と森のカーニバル〉着想）。**本牧の足元の深層に「幻の地下鉄駅」**（現実に無い駅）＝訓練拠点・隠れ家。ナギは**深層の異常に惹かれて寄り道する**性質（歩く exploit の表れ＝発見エンジン） | [../settings/locations.md](../settings/locations.md) |
...
| C-027 | **謎集団＝「道化の楽団」**（骸骨化粧・赤い衣装・手回しオルガン／署名＝「炎と森のカーニバル」＝森と火の粉の意匠。SEKAI NO OWARI のMVモチーフ）。**深層の異常（バグ）に乗じて、実在地ダンジョンの本来の出現（native）を上書きして侵入する正体不明の集団**＝乱入（invasion・[dungeon_design §1.5-5](../settings/dungeon_design.md)）の特殊版。**第1話で初遭遇**（本来の native＝ずぶ濡れの獣を上書き）。**正体・目的・誰の差し金かは後巻回収**。**B1 では「別個の存在の気配」のみ**（Mythos と同等の伏せレベル＝FABの「これ、ここの子じゃない」止まり。git/バグ語は不出） | [../series/disclosure_ledger.md](../series/disclosure_ledger.md)・[../plot/ep1_plot.md](../plot/ep1_plot.md) |
