...
| C-025 | ヒロイン（仮称・澪）＝山手の**女子校・弓道部**の少女。**登録された監視者**（体制側の善人）だが**ナギを見逃す葛藤型**。能力＝**弓型タトゥー（遠隔で一点を撃ち抜く＝ピンポイント編集・戻り標を射抜く）**＝第1話「帰還の脆さ」の人格化。**和＝日本に根ざす者**でハーフ主人公の対比。改変=禁忌を信じる立場＝10巻受容と将来衝突。剣の少年案を置換（剣は後巻ライバル候補に温存） | [../settings/heroine_core.md](../settings/heroine_core.md) |
