...
17. **【次の一手・著者決定待ち＝blocker】第9話の本文化**（B1-09）。**著者決定＝①引きの視点（v0.2はナギ視点＋"待っていた目"の一像＋時計一拍の二段引きを提案）②タイトル（核へ／待っている人／いちばん深いところ）**。決まり次第、本文化→4レビュー。or **第10話プロット**（B1-10「足跡の手前」＝go darkの一歩手前で挫く＋鵜飼の決定的接触＝第3ブロックへの跳躍台）を5レビューで先行も可。
18. 任意：巻1の縦糸（削れの天秤／監視／澪の仲間化／喪失／道化の気配）の出し入れを第2〜巻末ブロックで配分（[book1_skeleton.md §2](../plot/book1_skeleton.md)）。
19. 任意：ストーリーボード（隠れ家establishing は確定済アセットあり／点vs面の共闘絵は第4話／鵜＝白い光の意匠／第7話＝点vs面の攻めの三速度＝緋色の装束が翻り矢が縦に貫く9コマ／第8話＝既視感のマッチカット・鵜の光が動線に灯る引き／第9話＝核へ降りる漆黒・待っていた目の決め画）。

> 進捗：第2ブロックは**第5〜8話本文 v0.2 ＋第9話プロット v0.2 まで完成**（鵜飼人物設計＋戻り標/シード機構C-036＋ep5-9プロット＋第5〜8話本文）。**本セッションで第7話本文化＋第8話プロット＋第8話本文化（著者決定）＋第9話「核へ」プロットまで完了**（いずれも全レビュー収束反映・main マージ済）。第2ブロックの山（露見）を越え、go dark本番（核へ）の設計まで到達。次は第9話本文化（著者決定＝引きの視点/タイトル待ち）or 第10話「足跡の手前」プロット。
