...
- ✅ **第1話 本文 v0.2**：[manuscript/book1/01-01_modori_jirushi.md](../manuscript/book1/01-01_modori_jirushi.md)「戻り標」（レビュー反映＋横浜グラウンディング＝学校:山手／ダンジョン:みなとみらい駅。機械検査NG0）。レビュー＝[review/01-01_*](../review/)
...
0. **第1話＝案3で確定**（駅地下・二重生活／FAB=D3ヘッドホンの声の正体／引き=F3削れ予兆）。プロット＝[../plot/ep1_plot.md](../plot/ep1_plot.md)。**力の背骨＝編集層**（[../settings/ability_progression.md](../settings/ability_progression.md)：《晴れ間》=L0→重力→ブラックホール→01/量子、徐々に開放）。次は**本文化 or 案3の冒頭ストーリーボード再試作**。重力/量子は完全隠蔽（1話はL0と仕込みのみ）。
