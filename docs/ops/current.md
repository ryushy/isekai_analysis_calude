...
- ✅ **第1話 v0.3 完了**（横浜＝本牧自宅/山手駅学校/みなとみらいダンジョン・レビュー反映・約6,000字）。✅ **第2話プロット v0.2 done**＝[../plot/ep2_plot.md](../plot/ep2_plot.md)「見られていた」（**剣の少年→弓道狙撃ヒロインに置換**・[../settings/heroine_core.md](../settings/heroine_core.md) 新設）。
