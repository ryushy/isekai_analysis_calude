...
- ✅ **第3話 本文 v0.2**：[03-01_owaranai_shuchakueki.md](../manuscript/book1/03-01_owaranai_shuchakueki.md)「終わらない終着駅」（拠点獲得＝タグ固定・スローライフ＋削れの種・**おばさんの口ぐせ「いってらっしゃい。寄り道は、ほどほどにね」を先植え**）。
- ✅ **第4話 本文 v0.2**：[04-01_nemutteiru_aida_ni.md](../manuscript/book1/04-01_nemutteiru_aida_ni.md)「眠っている間に」（特訓失敗・澪合流・点vs面の共闘・**澪に庇い返されて削れを受容＝口ぐせが消える**・澪が証人）。
